...
class PostgresSystemEnvironment(SystemEnvironment):
    ...
    def execute(self, workload, explain=True):
        ...
        for query in workload:
            ...
            try: 
                with self.tpch_cxn.cursor() as curs:
                    ...
                    query_runtime.append(runtime)
                    workload_runtime = workload_runtime + runtime 
        ...
        avg_query_runtime = workload_runtime/len(workload)

        return workload_runtime, avg_query_runtime, query_runtime, w_idx
...
class TunerPostgresSystemEnvironment(SystemEnvironment):
    """
        Encapsulates environment
